                ...
                <div class="card overflow-auto">
                    <div class="card-body">
                        ...
                        <table class="table table-borderless datatable">
                            ...
                            <c:forEach items="${requestScope.preguntas}" var="p">
                                <tr>
                                    ...
                                    <td>${p.categoria.id} - ${p.categoria.contenido}</td>
                                    <td>${p.contenido}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/preguntas?view=update-form&id=${p.id}"
                                           onclick="return confirm('&iquest;Est&aacute; seguro que desea editar los datos de la pregunta?');"
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/preguntas?view=delete&id=${p.id}"
                                           onclick="return confirm('&iquest;Est&aacute; seguro que desea eliminar la pregunta?');"
                        ...
                        <div style="padding: 8px 10px !important;">
                            <a href="${pageContext.request.contextPath}/preguntas?view=add-form"
                               class="btn btn-primary">Crear una Pregunta</a>
                        </div>
                    </div>
                </div>
            </div>

    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Editar una Categor&iacute;a</h5>
                        <form class="row g-3" method="post"
                              action="${pageContext.request.contextPath}/categorias?action=update">
                            <div class="col-12"><label for="input1" class="form-label">Definici&oacute;n</label>
                                <input type="text"
                                       class="form-control"
                                       id="input1"
                                       name="contenido"
                                       value="${requestScope.categoria.contenido}"
                                       required>
                            </div>
